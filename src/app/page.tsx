  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-parchment">
      <div className="text-center">
        <div className="text-5xl font-serif italic text-gold-700 mb-2 text-gold-glow tracking-wide">Vinoteca</div>
  ...
  return (
    <div className="min-h-screen bg-parchment flex flex-col">
      ...
      <header className="bg-cave-700/90 backdrop-blur-md border-b border-gold-900/30 text-ink px-4 py-3 flex items-center justify-between sticky top-0 z-50">
        <button onClick={() => setScreen('home')} className="font-serif italic text-xl tracking-wider text-gold-700">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="text-xs text-cave-100 hover:text-gold-700 transition-colors"
          >
            {lang === 'ja' ? 'ログアウト' : '로그아웃'}
          </button>
        </div>
