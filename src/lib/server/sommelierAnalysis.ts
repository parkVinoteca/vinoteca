...
export function readSommelierDetails(raw:Record<string,unknown>, history:HistoryContext, identified:boolean) {
  ...
  const comment=identified && references.length ? text(raw.comment) : null
