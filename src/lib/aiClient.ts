...
export const messages = {
  ...
  ko: { more_tastings_required: '평점이 있는 테이스팅 기록을 3병 이상 작성해주세요.', wine_details_required: '와인명을 입력하거나 라벨 사진을 선택해주세요.', invalid_request: '입력 내용을 확인해주세요. 빈티지는 네 자리 연도 또는 NV입니다.', provider_auth_failed: 'AI 연결 설정 확인이 필요합니다. 사진을 다시 찍을 필요는 없습니다.', provider_billing: 'AI 제공사의 사용 잔액·결제 설정 확인이 필요합니다.', provider_model_unavailable: 'AI 모델을 사용할 수 없습니다. 관리자 설정 확인이 필요합니다.', provider_busy: 'AI 제공사가 혼잡하거나 사용 한도에 도달했습니다. 잠시 후 다시 시도해주세요.', provider_timeout: 'AI 응답이 지연되고 있습니다. 잠시 후 다시 시도해주세요.', provider_unavailable: 'AI 제공사에 연결하지 못했습니다. 잠시 후 다시 시도해주세요.', provider_request_failed: 'AI 요청을 처리하지 못했습니다. 관리자가 원인을 확인하겠습니다.', invalid_ai_result: 'AI 답변을 읽지 못했습니다. 다시 시도해주세요.', sign_in_required: '다시 로그인해주세요.', usage_limit: '사용 한도에 도달했거나 연속 요청입니다. 잠시 후 다시 시도해주세요.', analysis_failed: '분석하지 못했습니다. 사진을 확인하고 다시 시도해주세요.', temporarily_unavailable: '현재 이 기능을 사용할 수 없습니다. 잠시 후 다시 시도해주세요.', invalid_image: 'JPEG 또는 PNG 라벨 사진을 선택해주세요.', image_too_large: '이미지가 너무 큽니다. 더 작은 이미지로 시도해주세요.', label_unreadable: '라벨을 읽지 못했습니다. 밝고 선명한 사진으로 시도해주세요.', search_unavailable: '출처를 확인하지 못했습니다. 잠시 후 다시 시도해주세요.' },
}
